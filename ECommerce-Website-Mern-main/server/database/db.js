...
const Connection = async (username, password) => {
    ...
    //const URL= `mongodb+srv://${username}:${password}@ecommerce-web1.le3cy8n.mongodb.net/?retryWrites=true&w=majority&appName=Ecommerce-web1`
    const URL= `mongodb+srv://1234andiyas:${password}@ecommerce-web1.le3cy8n.mongodb.net/?retryWrites=true&w=majority&appName=Ecommerce-web1`
    try {
